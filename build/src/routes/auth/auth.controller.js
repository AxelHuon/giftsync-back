...
const authtoken_model_1 = __importDefault(
  require("../../models/authtoken.model"),
);
const authtokenForgotPassword_model_1 = __importDefault(
  require("../../models/authtokenForgotPassword.model"),
);
  ...
  signInUser(body, errorResponse) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        if (user) {
          const passwordValid = yield bcrypt.compare(
            passwordRequest,
          ...
          if (tokenExists) {
            yield authtoken_model_1.default.destroy({
              where: { id: tokenExists.id },
            });
          }
          const refreshToken =
            yield authtoken_model_1.default.createToken(user);
          const token = jsonwebtoken_1.default.sign(
            { id: user.id },
            secretKey !== null && secretKey !== void 0 ? secretKey : "",
            {
  ...
  refreshToken(body, errorResponse) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const isExpired =
          yield authtoken_model_1.default.verifyAndDeleteExpiredToken(
            refreshToken,
          );
        if (isExpired) {
          return errorResponse(403, {
        ...
        const newAccessToken = jsonwebtoken_1.default.sign(
          { id: user.id },
          (_a = node_process_1.default.env.JWT_SECRET) !== null && _a !== void 0
            ? _a
            : "",
          {
            expiresIn: node_process_1.default.env.JWT_EXPIRATION || "24h",
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const forgotPasswordToken =
          yield authtokenForgotPassword_model_1.default.createForgotPasswordToken(
            user,
          );
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const tokenInformation =
          yield authtokenForgotPassword_model_1.default.findOne({
            where: { token: token },
          });
        const isExpired =
          yield authtokenForgotPassword_model_1.default.verifyAndDeleteExpiredTokenForgotPassword(
            tokenInformation,
          );
        if (isExpired) {
          return errorResponse(403, {
...
__decorate(
  [
    ...
    (0, tsoa_1.Middlewares)([
      (0, validation_middleware_1.validationBodyMiddleware)(
        auth_interface_1.RegisterUserRequest,
      ),
    ]),
...
__decorate(
  [
    ...
    (0, tsoa_1.Middlewares)([
      (0, validation_middleware_1.validationBodyMiddleware)(
        auth_interface_1.SignInUserRequest,
      ),
    ]),
    __param(0, (0, tsoa_1.Body)()),
    __param(1, (0, tsoa_1.Res)()),
...
__decorate(
  [
    ...
    (0, tsoa_1.Middlewares)([
      (0, validation_middleware_1.validationBodyMiddleware)(
        auth_interface_1.RefreshTokenRequest,
      ),
    ]),
    __param(0, (0, tsoa_1.Body)()),
    __param(1, (0, tsoa_1.Res)()),
...
__decorate(
  [
    ...
    (0, tsoa_1.Middlewares)([
      (0, validation_middleware_1.validationBodyMiddleware)(
        auth_interface_1.ForgotPasswordRequest,
      ),
    ]),
    __param(0, (0, tsoa_1.Body)()),
    __param(1, (0, tsoa_1.Res)()),
...
__decorate(
  [
    ...
    (0, tsoa_1.Middlewares)([
      (0, validation_middleware_1.validationBodyMiddleware)(
        auth_interface_1.ResetPasswordRequest,
      ),
    ]),
    __param(0, (0, tsoa_1.Body)()),
    __param(1, (0, tsoa_1.Res)()),
...
exports.AuthController = AuthController = __decorate(
  [(0, tsoa_1.Tags)("Auth"), (0, tsoa_1.Route)("auth")],
  AuthController,
);
